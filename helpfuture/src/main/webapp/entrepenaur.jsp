...
<body class="vh-100 bg-empre">
  	...
  	<div class="container-fluid">
    	...
    	<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <li class="nav-item">
	        ...
	        <li class="nav-item">
	          <a class="nav-link active" href="entrepenaur.jsp">Emprendedores</a>
	        </li>
	        <li class="nav-item">
	...
	<div class="container-fluid vh-100 mb-3">
	    <div class="row d-flex text-left mx-4">	
	      	<div class="col-md-6">
	      		<h1 class="h1 text-center mt-5 mb-5 til-color">Listado de Emprendedores</h1>
...
<script src="assets/jsc/verificar.js" type="text/javascript"></script>
